<script lang="ts">
	...
	const stops = [
		...
		{ id: 'rewind', year: '↻', label: 'Rewinding…' },
...
<svelte:head>
	...
	<meta property="og:description" content="For as long as I have lived, I have loved to create. Startups, apps, videos. I live to create. I work to delight." />
</svelte:head>
