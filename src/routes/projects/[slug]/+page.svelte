	...
	{#if data.project}
		<header class="project-header">
			...
			<div class="project-links">
				{#if data.project.externalUrl}
					<Button href={data.project.externalUrl} size="lg">
				...
				{#if data.project.githubUrl}
					<Button href={data.project.githubUrl} variant="secondary" size="lg">
		...
		{#if data.project.coverImage}
			<div class="project-cover">
				<img src={data.project.coverImage} alt={data.project.title} />
			</div>
		{/if}
			...
			<div class="project-gallery">
				...
				<div class="gallery-grid">
					{#each getImages() as image, i}
						<img src={image} alt="{data.project.title} screenshot {i + 1}" loading="lazy" />
					{/each}
				</div>
			</div>
		{/if}
