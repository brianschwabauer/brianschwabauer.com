...
const HOME_SECTIONS: SearchEntry[] = [
	{
		...
		type: 'home',
		title: 'Today',
		summary: 'The current chapter — what I am working on right now.',
		body: '',
		tags: ['About', 'Intro', 'Today'],
		date: Date.now(),
		url: '/#hero',
	...
	{
		id: 'home:humble-beginnings',
		type: 'home',
		title: 'Humble Beginnings',
		summary: 'A miniDV camera, a bedroom green screen, and a friend named Kevin.',
		body: '',
		tags: ['Film', '2006'],
	...
	{
		id: 'home:green-screen',
		type: 'home',
		title: 'Green Screen',
		summary: 'Painting a wall green and learning compositing.',
		body: '',
		tags: ['Film', 'VFX', '2007'],
	...
	{
		id: 'home:taking-it-seriously',
		type: 'home',
		title: 'First Websites',
		summary: 'The first websites — taking the work seriously.',
		body: '',
		tags: ['Web', '2009'],
		date: new Date('2009-01-01').getTime(),
		url: '/#taking-it-seriously',
		imageUrl: mediaUrl('2009-01-01_hunky_spunky_productions_website_scroll.avif'),
	},
	{
		id: 'home:music-videos',
		type: 'home',
		title: 'Music Videos',
		summary: 'Shooting and editing music videos.',
		body: '',
		tags: ['Film', 'Music Video', '2010'],
		date: new Date('2010-01-01').getTime(),
		url: '/#music-videos',
		imageUrl: mediaUrl('2010-03-25_do_da_flava_g-whole_family_dances_in_back_yard.avif'),
	},
	{
		id: 'home:animation',
		type: 'home',
		title: 'Animation & VFX',
		summary: 'Compositing, motion graphics, and visual effects.',
		body: '',
		tags: ['Film', 'Animation', 'VFX', '2011'],
	...
	{
		id: 'home:festivals-ksms',
		type: 'home',
		title: 'Festivals & KSMS',
		summary: 'Film festivals and Kalamazoo School for the Arts.',
		body: '',
		tags: ['Film', 'Festival', '2011'],
		date: new Date('2011-06-01').getTime(),
		url: '/#festivals-ksms',
		imageUrl: mediaUrl('2011-04-14_this_is_ksms-basketball_trick_shot_with_vfx.avif'),
	},
	{
		id: 'home:spunksters',
		type: 'home',
		title: 'The Spunksters',
		summary: 'The Spunksters — short films and creative experiments.',
		body: '',
		tags: ['Film', '2013'],
		date: new Date('2013-01-01').getTime(),
		url: '/#spunksters',
		imageUrl: mediaUrl('2013-06-22_the_spunksters-logo_animation.avif'),
	},
	{
		id: 'home:college',
		type: 'home',
		title: 'College',
		summary: 'College years — film school and finding my voice.',
		body: '',
		tags: ['About', 'College', '2014'],
	...
	{
		id: 'home:what-makes-us-human',
		type: 'home',
		title: 'Senior Thesis: What Makes Us Human',
		summary: 'Senior thesis film — what makes us human.',
		body: '',
		tags: ['Film', 'Thesis', '2015'],
		date: new Date('2015-01-01').getTime(),
		url: '/#what-makes-us-human',
		imageUrl: mediaUrl(
	...
	},
	{
		...
		type: 'home',
		title: 'Freelancer',
		summary: 'Freelance work — film, web, and design.',
		body: '',
		tags: ['Work', 'Freelance', '2017'],
	...
	{
		id: 'home:entrepreneurship',
		type: 'home',
		title: 'Entrepreneurship',
		summary: 'Starting things — the entrepreneurial chapter.',
		body: '',
		tags: ['Work', 'Startup', '2019'],
		date: new Date('2019-01-01').getTime(),
		url: '/#entrepreneurship',
		imageUrl: mediaUrl('2016-01-01_tower_of_the_americas_panorama-little_planet.avif'),
	},
	{
		id: 'home:showandtour',
		type: 'home',
		title: 'Show&Tour',
		summary: 'Building Show&Tour — the company.',
		body: '',
		tags: ['Work', 'Showandtour', 'Startup', '2024'],
